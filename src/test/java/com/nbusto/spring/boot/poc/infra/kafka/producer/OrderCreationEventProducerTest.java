...
@DirtiesContext
@Testcontainers
class OrderCreationEventProducerTest {
    ...
    private Consumer<String, CreateOrder> createConsumer() {
        final var consumerFactory = new DefaultKafkaConsumerFactory<String, CreateOrder>(CONSUMER_PROPS);
